...
const Cadastro = () => {
    ...
    const aoDigitarNoCampo = (campo: "nome"|"renda", valor: string)=>{
                    ...
                    <Form>
                        <Fieldset>
                            ...
                            <CampoTexto
                                ...
                                name="nome"
                                value={form.nome}
                                onChange={(e:React.ChangeEvent<HTMLInputElement>) => aoDigitarNoCampo("nome", e.target.value)}
                            />
                        </Fieldset>
                        <Fieldset>
                            ...
                            <CampoTexto
                                ...
                                name="renda"
                                value={form.renda}
                                onChange={(e:React.ChangeEvent<HTMLInputElement>) => aoDigitarNoCampo("renda",e.target.value)}
                            />
                        </Fieldset>
                    </Form>
